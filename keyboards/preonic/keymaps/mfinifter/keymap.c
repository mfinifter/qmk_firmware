...
[_DVORAK] = LAYOUT_preonic_grid(
  ...
  KC_BTN1, KC_BTN2, KC_DEL, KC_BSPC, KC_LGUI, LT(_LOWER, KC_SPC),  LT(_RAISE, KC_ENT), KC_RCTL, KC_RALT, KC_BSLS, KC_UP,   KC_RGHT
),
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, MEH(KC_V), _______, _______, _______, _______, _______,_______, _______, _______, 
  _______, _______, LSA(KC_J), MEH(KC_C), LSA(KC_P), _______, _______, _______, _______,_______, _______, _______, 
